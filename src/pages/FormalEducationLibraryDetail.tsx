...
const FormalEducationLibraryDetail: React.FC = () => {
  ...
  const handleShare = () => {
    if (navigator.share) {
      navigator.share({
        title: item?.title || "مادة من مكتبة التعليم النظامي",
  ...
  const breadcrumbItems = [
    { label: "مكتبة التعليم النظامي", path: "/formal-education-library" },
    { label: item.title },
  ];
...
export default FormalEducationLibraryDetail;
