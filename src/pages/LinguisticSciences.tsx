...
const LinguisticSciences: React.FC = () => {
  ...
  // Fetch paginated entries for Linguistic Sciences from API
  const {
    data: paginatedData,
    loading,
    error,
  ...
  // Fetch subcategories for Linguistic Sciences
  const { data: subcategories, loading: subcategoriesLoading } =
    useSubcategoriesByCategorySlug("aلعلوم-aللغوية");
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="max-w-2xl mx-auto mb-8">
          <SearchBar
            ...
            placeholder="ابحث في العلوم اللغوية..."
          />
        </div>
        ...
        {error && (
          <div className="text-center py-16">
            ...
            <p className="text-medium-gray">
              حدث خطأ أثناء تحميل العلوم اللغوية. يرجى المحاولة مرة أخرى.
            </p>
          </div>
        )}
...
export default LinguisticSciences;
