...
export const categories: Category[] = [
  ...
  },
  {
    ...
    subcategories: [
      { id: 'basic-education', name: 'مكتبة التعليم الأساسي', slug: 'basic-education' },
      { id: 'secondary-education', name: 'مكتبة التعليم الثانوي', slug: 'secondary-education' },
      { id: 'university-education', name: 'مكتبة التعليم الجامعي', slug: 'university-education' }
    ]
  },
  {
    id: 'scientific-news',
